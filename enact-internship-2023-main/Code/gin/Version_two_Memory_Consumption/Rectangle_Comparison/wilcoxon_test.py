...
original_file_path = "rectangle_original/jx_results/jx_process_level_methods.csv"
optimized_file_path = "rectangle_optimised/jx_results/jx_process_level_methods.csv"
...
print("Original Rectangle Total Energy Mean:", energy_original_mean)
print("Original Rectangle Total Energy Std Deviation:", energy_original_std)
print("95% Confidence Interval for Original Rectangle Total Energy Mean:", confidence_interval_original)
print("Percentage of Error for Original Rectangle Total Energy Mean:", percentage_error_original)

print("Optimized Rectangle Total Energy Mean:", energy_optimized_mean)
print("Optimized Rectangle Total Energy Std Deviation:", energy_optimized_std)
print("95% Confidence Interval for Optimized Rectangle Total Energy Mean:", confidence_interval_optimized)
print("Percentage of Error for Optimized Rectangle Total Energy Mean:", percentage_error_optimized)
