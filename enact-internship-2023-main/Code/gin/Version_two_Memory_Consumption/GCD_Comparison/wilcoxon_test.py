...
original_file_path = "GCD_original/jx_results/jx_process_level_methods.csv"
optimized_file_path = "GCD_optimised/jx_results/jx_process_level_methods.csv"
...
print("Original GCD Total Energy Mean:", energy_original_mean)
print("Original GCD Total Energy Std Deviation:", energy_original_std)
print("95% Confidence Interval for Original GCD Total Energy Mean:", confidence_interval_original)
print("Percentage of Error for Original GCD Total Energy Mean:", percentage_error_original)

print("Optimized GCD Total Energy Mean:", energy_optimized_mean)
print("Optimized GCD Total Energy Std Deviation:", energy_optimized_std)
print("95% Confidence Interval for Optimized GCD Total Energy Mean:", confidence_interval_optimized)
print("Percentage of Error for Optimized GCD Total Energy Mean:", percentage_error_optimized)
