...
gin.LocalSearch.search() INFO: Original memory consumption: 564 Mbytes
gin.LocalSearch.search() INFO: Step: 1, Patch: | gin.edit.line.ReplaceLine "examples/triangle/Triangle.java":19 -> "examples/triangle/Triangle.java":8 |, Failed to compile
gin.LocalSearch.search() INFO: Step: 2, Patch: | gin.edit.line.CopyLine "examples/triangle/Triangle.java":33 -> "examples/triangle/Triangle.java":17 |, Failed to compile
..
gin.LocalSearch.search() INFO: Step: 45, Patch: | gin.edit.line.ReplaceLine "examples/triangle/Triangle.java":41 -> "examples/triangle/Triangle.java":41 |, Memory: 1221 Mbytes
..
gin.LocalSearch.search() INFO: Step: 57, Patch: |, New best memory consumption: 356 Mbytes
..
gin.LocalSearch.search() INFO: Finished. Best memory consumption: 356 Mbytes, Memory reduction: 36.88%, Patch: |
```
